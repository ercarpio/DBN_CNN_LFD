...
if __name__ == '__main__':
    ...
    for iteration in range(NUM_ITER):
        ...
        n_seq, n_seq2, img_data, pnt_data, aud_data, num_prompts, label_data, img_data2, pnt_data2, aud_data2, names = dqn.sess.run(
    ...
    bins = {'z': [0, 0], 'g': [0, 0], 'a': [0, 0], 'zg': [0, 0], 'ga': [0, 0], 'zg': [0, 0], 'zga': [0, 0],
            'none': [0, 0]}
    for p in good:
        for k in bins:
            act = np.argmax(p[2])
